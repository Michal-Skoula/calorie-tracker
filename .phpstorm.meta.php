...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/michal/Documents/Development/Projects/calorie-tracker/public/storage' => 'string',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.links./home/michal/Documents/Development/Projects/calorie-tracker/public/storage','logging.default',
...
'mail.from.address','mail.from.name','mail.markdown.theme','mail.markdown.paths','openai.api_key',
'openai.organization','openai.request_timeout','queue.default','queue.connections.sync.driver','queue.connections.database.driver',
...
'web','api',);
        registerArgumentsSet('routes', 'dashboard','add','settings',
'store','profile.edit','profile.update','profile.destroy','register','login','password.request','password.email',
...
'add','auth.confirm-password','auth.forgot-password','auth.login','auth.register',
...
'VITE_APP_NAME','OPENAI_API_KEY','OPENAI_ORGANIZATION',);
